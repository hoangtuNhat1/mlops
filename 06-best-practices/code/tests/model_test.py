...
def test_base64_decode():
    ...
    assert (
        flower_data == expected_flower
    ), f"Expected {expected_flower}, but got {flower_data}"
...
def test_predict():
    ...
    model_service = model.init(
        "flower_stream", "72e6547ed6a24ee9bebedb981ea11114", "123", False
    )
...
def test_lambda_handler():
    ...
    model_service = model.init(
        "flower_stream", "72e6547ed6a24ee9bebedb981ea11114", "123", True
    )
    ...
    expected_prediction = {
        ...
        "prediction": {"flower": {"prediction": "versicolor"}, "flower_id": 156},
    }
